...
import static com.anapedra.blogbackend.entities.enuns.UserStatus.BLOCKED;
...
public class DevConfiguration implements CommandLineRunner {
    ...
    public DevConfiguration(UserRepository userRepository, RoleRepository roleRepository, PostRepository postRepository,
                            CategoryRepository categoryRepository, CommentRepository commentRepository, ReplyRepository replyRepository) {
    ...
    public void run(String... args) throws Exception {
       ...
       ;
        ...
        Role role3=new Role(null,"ROLE_MAIN_ADMIN");
        ...
        Comment comment1=new Comment(null,"Muito bom mesmo!", LocalDate.now(),LocalDate.now(),post1,user2);
        Comment comment2=new Comment(null,"Muito  ruin!",  LocalDate.now(), LocalDate.now(),post1,user2);
        Comment comment3=new Comment(null,"Não gostei!",LocalDate.now(), LocalDate.now(),post2,user1);
        Comment comment4=new Comment(null,"Não entend nada!", LocalDate.now(), LocalDate.now(),post1,user1);
